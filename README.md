...
> Nano check http security headers of a url

[![PyPI version](https://badge.fury.io/py/nano-header-check.svg)](https://pypi.org/project/nano-header-check/)
...
from nano_header_check import batch
